			...
			if($field=='history'){
				echo"<div id='wppizza_".$field."'>";
					...
					echo"<div id='wppizza_".$field."_search' class='button' style='overflow:auto'>";
						...
						echo "</select>";
						echo "</span>";
						echo " <span style='float:left;'>".__('maximum results [0 to show all]', 'wppizza-locale')."<input id='".$field."_orders_limit' size='3' type='text' value='".$options['plugin_data']['admin_order_history_max_results']."' /></span>";
						echo "<span style='float:right;margin-right:50px;'>";
						echo " ".__('poll for new orders every', 'wppizza-locale')."<input id='".$field."_orders_poll_interval' size='2' type='text' value='".$options['plugin_data']['admin_order_history_polling_time']."' />".__('seconds', 'wppizza-locale')." ";
